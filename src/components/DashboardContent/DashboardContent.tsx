...
const DashboardContent: React.FC<DashboardContentProps> = ({ blogs }) => {
  ...
  return (
    <div className="flex">
      ...
      <div className="flex flex-col w-1/2 mr-5">
        ...
        {blogs.length > 0 ? blogs.map((blog) => <YourBlog key={blog.id} src={blog.image} title={blog.title} />) : <p className="text-gray-500 mt-3">You haven&apos;t posted anything yet.</p>}
      </div>
